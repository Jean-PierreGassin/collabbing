  ...
  <AuthMorphCard title="Register" :action="session.routes.register" :success-href="session.routes.ideas" max-width="lg">
    <template #default="{ errorsFor, isSubmitting }">
      ...
      <div class="grid gap-4 sm:grid-cols-2">
        <FormField id="first_name" label="First name" :validator="personNameValidator" :external-errors="errorsFor('first_name')">
          <template #default="{ invalid, describedBy, feedbackClass }">
        ...
        <FormField id="last_name" label="Last name" :validator="personNameValidator" :external-errors="errorsFor('last_name')">
          <template #default="{ invalid, describedBy, feedbackClass }">
      ...
      <FormField id="email" label="Email address" :validator="emailValidator" :external-errors="errorsFor('email')">
        <template #default="{ invalid, describedBy, feedbackClass }">
      ...
      <div class="grid gap-4 sm:grid-cols-2">
        <FormField id="password" label="Password" help="Use at least 12 characters with letters and numbers." :validator="passwordValidator" :external-errors="errorsFor('password')">
          <template #default="{ invalid, describedBy, feedbackClass }">
        ...
        <FormField id="password_confirmation" label="Confirm password" :validator="passwordConfirmationValidator" :external-errors="errorsFor('password_confirmation')">
          <template #default="{ invalid, describedBy, feedbackClass }">
